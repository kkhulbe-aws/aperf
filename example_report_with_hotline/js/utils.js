let comparator = 'mean';
let all_run_keys = new Array();
let key_limits = new Map();
...
function addElemToNode(node_id, elem) {
    let node = document.getElementById(node_id);
    node.appendChild(elem);
}
function isDiffAcrossRuns(title, run_names, check_runs) {
...
function checkIsCommonKey(title, check_runs, check_common_keys) {
...
function get_inside_value(data) {
    var _a, _b, _c, _d;
    if ('F64' in data) {
        return (_a = data['F64']) !== null && _a !== void 0 ? _a : undefined;
    }
    else if ('UInt64' in data) {
        return (_b = data['UInt64']) !== null && _b !== void 0 ? _b : undefined;
    }
    else if ('String' in data) {
        return (_c = data['String']) !== null && _c !== void 0 ? _c : undefined;
    }
    else if ('Stats' in data) {
        return (_d = data['Stats'][comparator]) !== null && _d !== void 0 ? _d : undefined;
    }
    else {
        return undefined;
    }
