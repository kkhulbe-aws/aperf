...
var kernel_config_runs = new Map();
var kernel_config_run_names = [];
var kernel_config_common_keys = [];
function createEntries(container_id, values, level, run) {
    values === null || values === void 0 ? void 0 : values.forEach(function (value, index, arr) {
