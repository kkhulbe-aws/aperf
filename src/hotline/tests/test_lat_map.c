...
void test_init_lat_map() {
    cpu_system_config.latency_limits.l1_max_cycles = 10;
    cpu_system_config.latency_limits.l2_max_cycles = 50;
    cpu_system_config.latency_limits.l3_max_cycles = 200;
...
void test_insert_lat_map_entry() {    
    ...
    // Test NULL input
    insert_lat_map_entry(NULL);
    assert(lat_map != NULL); // Map should still exist
...
void test_parse_lat_map_entry() {
    ...
    aux_record_raw_t dram_record = {0};
    ...
    aux_record_raw_t invalid_record = {0};
